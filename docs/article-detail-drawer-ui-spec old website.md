...
> Status: Legacy Reference (non-implementable)
>
> Implement From: `docs/ARTICLE_DETAIL_DRAWER_UI_SPEC.md`
>
> Last Validated In PR: n/a (historical document)
>
> Component Owners: historical only (Project Phoenix), not applicable to v2 code ownership
>
> This file is retained for comparison and migration context only. Do not implement directly from this document.
